...
class ciscentos6::benchmark::3_2_4 {
  if ! defined(Ciscentos6::Common::Add_file_line['3_2_4 net.ipv4.conf.all.log_martians = 1']) {
    if $cis_benchmark_3_2_4 == 'failed' {   # remediate
      ciscentos6::common::add_file_line { '3_2_4 net.ipv4.conf.all.log_martians = 1':
        filepath => '/etc/sysctl.conf',
        addline => 'net.ipv4.conf.all.log_martians = 1',
        regex => '^net.ipv4.conf.all.log_martians',
      } ->
      ciscentos6::common::add_file_line { '3_2_4 net.ipv4.conf.default.log_martians = 1':
        filepath => '/etc/sysctl.conf',
        addline => 'net.ipv4.conf.default.log_martians = 1',
        regex => '^net.ipv4.conf.default.log_martians',
      } ->
      exec {'3_2_4 set the active kernel parameters':
