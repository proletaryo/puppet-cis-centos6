...
class ciscentos6::benchmark::3_1_2 {
  if ! defined(Ciscentos6::Common::Add_file_line['3_1_2 net.ipv4.conf.all.log_martians = 1']) {
    if $cis_benchmark_3_1_2 == 'failed' {   # remediate
      ciscentos6::common::add_file_line { '3_1_2 net.ipv4.conf.all.send_redirects = 0':
        filepath => '/etc/sysctl.conf',
        addline => 'net.ipv4.conf.all.send_redirects = 0',
        regex => '^net.ipv4.conf.all.send_redirects',
      } ->
      ciscentos6::common::add_file_line { '3_1_2 net.ipv4.conf.default.send_redirects = 0':
        filepath => '/etc/sysctl.conf',
        addline => 'net.ipv4.conf.default.send_redirects = 0',
        regex => '^net.ipv4.conf.default.send_redirects',
      } ->
      exec {'3_1_2 set the active kernel parameters':
