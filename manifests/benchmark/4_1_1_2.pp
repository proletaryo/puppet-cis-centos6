...
class ciscentos6::benchmark::4_1_1_2 {
  ...
  if ! defined(Ciscentos6::Common::Add_file_line['4_1_1_2 space_left_action = email']) {
    ciscentos6::common::add_file_line { '4_1_1_2 space_left_action = email':
      filepath => '/etc/audit/auditd.conf',
      addline => 'space_left_action = email',
      regex => '^space_left_action',
    } ->
    ciscentos6::common::add_file_line { '4_1_1_2 action_mail_acct = root':
      filepath => '/etc/audit/auditd.conf',
      addline => 'action_mail_acct = root',
      regex => '^action_mail_acct',
    } ->
    ciscentos6::common::add_file_line { '4_1_1_2 admin_space_left_action = halt':
      filepath => '/etc/audit/auditd.conf',
